		...
		*/
		?>
				...
				<div>
					...
					$users = apply_filters( 'acf_users_value', $users, $post_id ); ?>

					<select name="<?php echo esc_attr($field['name']); ?>" class="psp-project-users <?php echo esc_attr($field['class']); ?>" multiple>

						<?php if(($field['value']) && ($field['value'] != 'unassigned')): ?>
							<option value="unassigned"></option>
								<?php $task_user = get_user_by('id',$field['value']); ?>
							<option value="<?php echo esc_attr($field['value']); ?>" selected><?php echo wp_kses_post($task_user->user_nicename); ?></option>
						<?php else: ?>
							<option value="unassigned"></option>
						<?php endif; ?>
						...
						foreach( $users as $user ): if( $user == $field['value'] ) continue;
							...
							<option value="<?php echo esc_attr($user); ?>"><?php echo wp_kses_post($user_obj->user_nicename); ?></option>
