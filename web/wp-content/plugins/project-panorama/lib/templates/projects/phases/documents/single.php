...
<div id="<?php esc_attr_e( 'psp-project-' . $post_id . '-doc-' . $document['index'] ); ?>" class="list-item psp-document <?php psp_the_task_item_classes($post_id); ?>" <?php psp_parse_data_atts($data_atts); ?>>
	 ...
	 <?php do_action( 'psp_before_document' ); ?>
	    ...
	    <div class="psp-doc-title">
		    ...
		    <a href="<?php echo esc_attr($document['link']); ?>" target="_new"><strong class="doc-title"><?php echo esc_html($document['title']); ?></strong></a>
