<div class="psp-modal psp-hide psp-edit-lane" id="psp-edit-lane">
     <a class="modal-close psp-modal-x" href="#"><i class="fa fa-close"></i></a>

     <div class="psp-modal-header">
          <div class="psp-h2"><?php esc_html_e( 'Edit List', 'psp_projects' ); ?></div>
     </div>

     <form method="" action="post" class="psp-lane-form" data-post_id="<?php echo esc_attr($post_id); ?>">
